...
// };
//
// window.connect = function (port, closeCb) {
//   p = sp.activePort(port, closeCb);
// };
//
// window.upgrade = function() {
//   if (!p) return
//   p.sendReq({
//     req: req.firmwareUpgradePrepare(1111),
//     cb: function(data){
//
//       p.switchPlugin(p.ftPlugin);
//       p.transferFile(path.resolve(__dirname, '../../src/renderer-firmware/assets/firmware/AppFirmware-final4.2.bin'), {
//         onBegin: function() {
//           console.log('begin')
//         },
//
